            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="profile text-center">
                        <div class="avatar">
                            <img src=" <?php echo e($department->featured_image_url); ?> " alt="<?php echo e($department->name); ?>" class="img-circle img-responsive img-raised">
                        </div>
                        <div class="name">
               ...
               <!--  <div class="row">
                    <div class="profile text-center">
                        ...
                        <div class="namer">
                            <h3 class="title">Productos de la categoría: <?php echo e($department->name); ?> </h3>
                        </div>
                    </div>
                </div>
 -->
