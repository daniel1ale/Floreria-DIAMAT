<?php $__env->startSection('title', 'Bienvenido a Floreria DIANMAT de ' . config('app.name')); ?>
...
<!-- HEAD -->
    <div class="header header-filter" style="background-image: url('<?php echo e(asset('images/top.jpg')); ?>');">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h1 class="title">Bienvenido Floreria DIAMAT  de <?php echo e(config('app.name')); ?>.</h1>
...
<?php echo $__env->make('includes.footerok', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
