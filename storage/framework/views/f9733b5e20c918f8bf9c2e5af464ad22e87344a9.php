...
<div class="main main-raised">
    <div class="container">
        <div class="section">
            ...
            <hr> 
            <p>Tu carrito de compras contiene: <?php echo e(auth()->user()->cart->details->count()); ?> productos.</p>
            <table class="table">
                <thead>
                    <tr>
                ...
                <?php $__currentLoopData = auth()->user()->cart->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="text-center">
                            <img src="<?php echo e($detail->product->carr); ?> " height="75">
                        </td>
                        <td>
                            <a href=" <?php echo e(url('/products/'.$detail->product->id)); ?> " target="_blank"><?php echo e($detail->product->name); ?>
